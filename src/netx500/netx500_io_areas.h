...
#define NX500_DEF_ptNetxControlledPciConfigurationShadowRegisterBlockArea NX500_NETX_CONTROLLED_PCI_CONFIGURATION_SHADOW_REGISTER_BLOCK_AREA_T * const ptNetxControlledPciConfigurationShadowRegisterBlockArea = (NX500_NETX_CONTROLLED_PCI_CONFIGURATION_SHADOW_REGISTER_BLOCK_AREA_T * const)Addr_NX500_netx_controlled_pci_configuration_shadow_register_block;
